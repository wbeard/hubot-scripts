...
#
# Configuration:
#   YO_API_TOKENS   - (Object) The hash of tokens for YO {'rallyjarvis': 'asdfas-asdf1234'}
#   YO_HUBOT_NAME   - (String) The name you want to be the default sender of all the Yos
#
# Commands:
#   hubot yo from <yo username> - Sends a yo to all of the registered yo usernames subscribers.
